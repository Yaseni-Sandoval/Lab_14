<x-app-layout>
    <style>
        ...
        .card {
            ...
            margin-bottom: 20px;
            text-align: center;
            background: linear-gradient(rgba(189, 196, 199, 0.5), rgba(223, 196, 196, 0.5)),  no-repeat center center fixed;
        ...
        <div class="container mx-auto sm:px-6 lg:px-8">
            <div class="card">
                ...
                <div class="button-box">
                    <a href="{{ route('rentas.create') }}" class="bg-green text-white rounded px-4 py-2 hover:bg-green-600 transition" style="text-decoration: none;">Rentar Películas</a>
                </div>
